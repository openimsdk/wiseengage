...
const (
	...
	Customerservice_CheckCustomerExist_FullMethodName       = "/openim.wiseengage.customerservice.customerservice/CheckCustomerExist"
...
type CustomerserviceClient interface {
	...
	CheckCustomerExist(ctx context.Context, in *CheckCustomerExistReq, opts ...grpc.CallOption) (*CheckCustomerExistResp, error)
...
func (c *customerserviceClient) CheckCustomerExist(ctx context.Context, in *CheckCustomerExistReq, opts ...grpc.CallOption) (*CheckCustomerExistResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckCustomerExistResp)
	err := c.cc.Invoke(ctx, Customerservice_CheckCustomerExist_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CustomerserviceServer interface {
	...
	CheckCustomerExist(context.Context, *CheckCustomerExistReq) (*CheckCustomerExistResp, error)
...
func (UnimplementedCustomerserviceServer) CheckCustomerExist(context.Context, *CheckCustomerExistReq) (*CheckCustomerExistResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckCustomerExist not implemented")
}
...
func _Customerservice_CheckCustomerExist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckCustomerExistReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CustomerserviceServer).CheckCustomerExist(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Customerservice_CheckCustomerExist_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerserviceServer).CheckCustomerExist(ctx, req.(*CheckCustomerExistReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Customerservice_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CheckCustomerExist",
			Handler:    _Customerservice_CheckCustomerExist_Handler,
		},
		{
