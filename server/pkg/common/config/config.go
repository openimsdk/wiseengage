...
type Share struct {
	...
	WiseEngageAdmin []string `mapstructure:"wiseEngageAdmin"`
	ProxyHeader     string   `mapstructure:"proxyHeader"`
}

type RpcService struct {
	WiseEngage string `mapstructure:"wiseEngage"`
